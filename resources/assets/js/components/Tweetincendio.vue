            ...
            <div class="card">
                <div class="card-header bg-gradient- Light" style="background-color:rgb(177, 183, 193)">
                    <div class="row justify-content-between">
                        <div class="text-value-lg" style="color:black;">Categoría Incendio</div>&nbsp;
                        <div>
                            <button type="button" @click="abrirModal('tweetincendio','registrar')"
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar"
                                    @keyup.enter="listarTweetincendio(1,buscar,criterio)" class="form-control"
                                    placeholder="Texto a buscar">
                                <button type="submit" @click="listarTweetincendio(1,buscar,criterio)"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" v-model="buscar"
                                        @keyup.enter="listarTweetincendio(1,buscar,criterio)" name="due_date"
                                        class="form-control">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4" v-for="tweetincendio in arrayTweetincendio"
                            :key="tweetincendio.id">
                            <div class="card">
                                <div
                                    class="card-header text-white bg-gradient-danger pb-0 d-flex justify-content-between align-items-start">
                                    <br />
                                    <div>
                                        <div class="text-value cil-calendar">&nbsp;Fecha:</div>
                                        <td class="text-value" v-text="tweetincendio.fecha"></td>
                                        <br />
                                        <div class="text-value cib-twitter">&nbsp;Tweet:</div>
                                        <td class="text-value" v-text="tweetincendio.texto"></td>
                                    </div>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"  @click="mostrarMapa(tweetincendio.coordenadas)">Ver en
                                                Mapa</a>
                                ...
                                <div class="card-body row text-center">
                                    <div class="col">
                                        ...
                                        <div class="text-uppercase">
                                            <td v-text="tweetincendio.ubicacion"></td>
                                        </div>
                                    </div>
                                    <div class="c-vr"></div>
                                    <div class="col">
                                        ...
                                        <div class="text-uppercase">
                                            <td v-text="tweetincendio.cuenta_verificada"></td>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div v-show="errorTweetincendio" class="form-group row div-error">
                                <div class="text-center text-error">
                                    <div v-for="error in errorMostrarMsjTweetincendio" :key="error" v-text="error">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary"
                            @click="registrarTweetincendio()"> Guardar</button> </div>
    ...
    export default {
        data (){
            return {
                ...
                tituloModal : '',
                tipoAccion : 0,
                 errorTweetincendio : 0,
                errorMostrarMsjTweetincendio: [],
                pagination : {
                    'total' : 0,
                    'current_page' : 0,
                    'per_page' : 0,
        ...
        methods : {
            listarTweetincendio(page,buscar,criterio){
                let me=this;
                var url= '/tweetincendio?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayTweetincendio = respuesta.tweetincendio.data;
                    me.pagination= respuesta.pagination;
                     if(me.arrayTweetincendio.length==0){
                             Swal.fire({
                                icon:'success',
                            ...
                            me.buscar=''
                            me.criterio='texto'
                            me.listarTweetincendio(1, me.buscar, me.criterio);
                        }
                })
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarTweetincendio(page,buscar,criterio);
            },
             registrarTweetincendio(){
                if (this.validarTweetincendio()){
                    return;
                }
                let me = this;
                axios.post('/tweetincendio/registrar',{
                    
                    'texto': this.texto,
                    'ubicacion': this.ubicacion
                }).then(function (response) {
                    me.cerrarModal();
                    me.listarTweetincendio(1,'','texto');
                }).catch(function (error) {
                    console.log(error);
                });
            },
           validarTweetincendio(){
                this.errorTweetincendio=0;
                this.errorMostrarMsjTweetincendio =[];

                if (!this.texto) this.errorMostrarMsjTweetincendio.push("El texto del evento de emergencia no puede estar vacío.");
                if (!this.ubicacion) this.errorMostrarMsjTweetincendio.push("La ubicación del evento de emergencia no puede estar vacío.");

                if (this.errorMostrarMsjTweetincendio.length) this.errorTweetincendio = 1;

                return this.errorTweetincendio;
            },
            cargarPdf(){
             window.open('http://localhost:8000/tweetincendio/listarPdf','_blank');
            },
                ...
                switch(modelo){
                    case "tweetincendio":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar evento de Emergencia de Incendio';
                                this.texto = '';
                                this.ubicacion = '';
                                 this.tipoAccion = 1;
                                break;
        ...
        mounted() {
            this.listarTweetincendio(1,this.buscar,this.criterio);
          this.cargarMapa();
        }
    }
</script>
